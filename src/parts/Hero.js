...
import BuildWebsite from 'assets/images/Hero.jpeg';
    ...
    <section className="hero">
      <Fade bottom>
        <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
          ...
          <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
            We provide small and medium companies with latest designs
            to help you scale up your business.
          </p>

          <Button href="/" type="link" className="flex w-71 h-18 items-center px-14 py-5 text-white text-xl bg-theme-yellow rounded-lg shadow-2xl hover:bg-dark-theme-yellow transition duration-200">
            See Our Work
      ...
      <Fade bottom>
        <div className="flex pt-5 w-full justify-center items-center order-first md:w-full lg:order-last lg:w-1/2">
          <img className="" src={BuildWebsite} alt="Build Website" style={{ width: '700px' }} />
        </div>
      </Fade>
    </section>
  );
